...
class VlxdSettingsScreen extends ConsumerStatefulWidget {
  const VlxdSettingsScreen({super.key});

  @override
  ConsumerState<VlxdSettingsScreen> createState() => _VlxdSettingsScreenState();
}

class _VlxdSettingsScreenState extends ConsumerState<VlxdSettingsScreen> {
  ...
  void initState() {
    super.initState();
    final s = ref.read(vlxdEinvoiceSettingsProvider).settings;
  ...
  Future<void> _saveEinvoice() async {
    ...
    final store = ref.read(vlxdEinvoiceSettingsProvider);
    final number = int.tryParse(_invoiceNumber.text.trim()) ?? 1;
    final settings = VlxdEinvoiceSettings(
  ...
  Widget build(BuildContext context) {
    ...
    final einvoiceStore = ref.watch(vlxdEinvoiceSettingsProvider);
