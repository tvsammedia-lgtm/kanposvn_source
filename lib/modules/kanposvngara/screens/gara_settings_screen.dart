...
class GaraSettingsScreen extends ConsumerStatefulWidget {
  const GaraSettingsScreen({super.key});

  @override
  ConsumerState<GaraSettingsScreen> createState() => _GaraSettingsScreenState();
}

class _GaraSettingsScreenState extends ConsumerState<GaraSettingsScreen> {
  ...
  void initState() {
    super.initState();
    final s = ref.read(garaEinvoiceSettingsProvider).settings;
  ...
  Future<void> _saveEinvoice() async {
    ...
    final store = ref.read(garaEinvoiceSettingsProvider);
    final number = int.tryParse(_invoiceNumber.text.trim()) ?? 1;
    final settings = GaraEinvoiceSettings(
  ...
  Widget build(BuildContext context) {
    final einvoiceStore = ref.watch(garaEinvoiceSettingsProvider);
