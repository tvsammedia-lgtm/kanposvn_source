    ...
    return Scaffold(
      ...
      body: dashboardAsync.when(
        data: (metrics) {
          ...
          final completed = metrics['completedSessions'] ?? 0;
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('TỔNG QUAN HÔM NAY', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.pink)),
                const SizedBox(height: 24),
                Row(
                  children: [
                    Expanded(child: _buildMetricCard('Tổng Doanh Thu', '${revenue.toStringAsFixed(0)} đ', Colors.pink)),
                    const SizedBox(width: 16),
                    Expanded(child: _buildMetricCard('Ca Dịch Vụ Hoàn Thành', '$completed ca', Colors.green)),
                  ],
                ),
              ],
            ),
