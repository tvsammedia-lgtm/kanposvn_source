...
class PawnSettingsScreen extends ConsumerStatefulWidget {
  const PawnSettingsScreen({super.key});

  @override
  ConsumerState<PawnSettingsScreen> createState() => _PawnSettingsScreenState();
}

class _PawnSettingsScreenState extends ConsumerState<PawnSettingsScreen> {
  ...
  void initState() {
    super.initState();
    final s = ref.read(pawnEinvoiceSettingsProvider).settings;
  ...
  Future<void> _saveEinvoice() async {
    ...
    final store = ref.read(pawnEinvoiceSettingsProvider);
    final number = int.tryParse(_invoiceNumber.text.trim()) ?? 1;
    final settings = PawnEinvoiceSettings(
  ...
  Widget build(BuildContext context) {
    final einvoiceStore = ref.watch(pawnEinvoiceSettingsProvider);
