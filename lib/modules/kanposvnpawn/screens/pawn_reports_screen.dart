...
import '../services/pawn_report_service.dart';

/// Tab "Báo cáo" — mô phỏng tất cả 20 báo cáo Crystal (.rpt) từ
/// KANCAFE_VS2022_DEMO cho module Cầm Đồ.
class PawnReportsScreen extends ConsumerStatefulWidget {
  const PawnReportsScreen({super.key});

  @override
  ConsumerState<PawnReportsScreen> createState() => _PawnReportsScreenState();
}
...
class _PawnReportsScreenState extends ConsumerState<PawnReportsScreen> {
  ...
  Future<void> _runReport() async {
    ...
    try {
      final service = PawnReportService(ref.read(pawnIsarServiceProvider));
      final from = _from;
      final to = _to;
