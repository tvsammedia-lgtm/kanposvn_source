...
/// Mô hình dữ liệu mô phỏng báo cáo dạng Crystal Reports (.rpt của KANVLXD).
///
/// Gồm: tiêu đề, các dòng phụ đề, bảng (header nhiều dòng + dữ liệu),
/// dòng tổng cộng và khối chữ ký cuối trang. Kiểu trình bày khớp với
/// bộ báo cáo .rpt của KANVLXD_ONE (TDPOS.Reports.*).
