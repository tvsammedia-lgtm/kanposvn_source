...
class RestaurantNeonSyncService {
  ...
  RestaurantNeonSyncService(this._isarService);
  ...
  Future<bool> triggerSync(String vercelApiUrl, String apiKey) async {
    ...
    try {
      ...
      final engine = SnapshotSyncEngine(
        ...
        appCode: 'kanposvnnhahangquanan',
        collections: [
          SnapshotSyncCollection(collection: isar.restaurantTables, keyField: 'tableId'),
          SnapshotSyncCollection(collection: isar.restaurantMenuItems, keyField: 'itemId'),
          SnapshotSyncCollection(collection: isar.restaurantOrders, keyField: 'orderId'),
          SnapshotSyncCollection(collection: isar.restaurantIngredients, keyField: 'ingredientId'),
          SnapshotSyncCollection(collection: isar.restaurantInventoryTxs),
        ],
      );
