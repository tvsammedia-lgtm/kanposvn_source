...
class _PosOrderScreenState extends ConsumerState<PosOrderScreen> {
          ...
          Row(
            ...
            children: [
              Column(
                ...
                onPressed: () async =>
                    await ref.read(cafePosCartProvider.notifier).startNewOrder(),
              ),
            ],
          ),
          const Divider(),
              ...
              return Expanded(
                child: Padding(
                  ...
                  child: ChoiceChip(
                    ...
                    selected: isSel,
                    onSelected: (_) =>
                        ref.read(cafePosCartProvider.notifier).setOrderType(t),
                  ),
                ),
              );
            }).toList(),
  ...
  Future<void> _printReceiptPdf(CafeOrder cart) async {
    await printBillPdf(cart);
  }
              ...
              actions: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (context.mounted) {
                      _printReceiptPdf(completedOrder);
