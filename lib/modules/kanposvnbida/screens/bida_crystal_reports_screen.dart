...
import '../services/bida_report_service.dart';

/// Tab "Báo cáo" — mô phỏng tất cả 20 báo cáo Crystal (.rpt) từ
/// KANCAFE_VS2022_DEMO cho module Bida.
class BidaCrystalReportsScreen extends ConsumerStatefulWidget {
  const BidaCrystalReportsScreen({super.key});

  @override
  ConsumerState<BidaCrystalReportsScreen> createState() => _BidaCrystalReportsScreenState();
}
...
class _BidaCrystalReportsScreenState extends ConsumerState<BidaCrystalReportsScreen> {
  static const _reports = [
    ...
    _ReportDescriptor('shrinkage', 'Hao hụt mặt hàng', 'rpBaoCaoHaoHut', Icons.warning_amber, _ReportGroup.inventory),
    ...
    _ReportDescriptor('payment_by_id', 'Chi tiền theo mã', 'rpPaymentByPaymentID', Icons.money_off, _ReportGroup.payment),
  ...
  Future<void> _runReport() async {
    ...
    try {
      final service = BidaReportService(ref.read(bidaIsarServiceProvider));
      final from = _from;
      final to = _to;
