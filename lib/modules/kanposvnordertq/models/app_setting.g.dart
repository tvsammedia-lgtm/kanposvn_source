...
extension AppSettingQueryWhere
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterWhereClause> updatedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterWhereClause> updatedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingQuerySortBy
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> sortByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingQuerySortThenBy
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> thenByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.desc);
    });
  }
...
extension AppSettingQueryWhereDistinct
  ...
  QueryBuilder<AppSetting, AppSetting, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingQueryProperty
  ...
  QueryBuilder<AppSetting, String?, QQueryOperations> descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
