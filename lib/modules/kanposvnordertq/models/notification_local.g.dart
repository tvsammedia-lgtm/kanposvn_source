...
extension NotificationLocalByIndex on IsarCollection<NotificationLocal> {
  Future<NotificationLocal?> getByNotificationId(String notificationId) {
    return getByIndex(r'notificationId', [notificationId]);
  }

  NotificationLocal? getByNotificationIdSync(String notificationId) {
  ...
  Future<List<NotificationLocal?>> getAllByNotificationId(
  ...
  List<NotificationLocal?> getAllByNotificationIdSync(
      List<String> notificationIdValues) {
    final values = notificationIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByNotificationId(NotificationLocal object) {
    return putByIndex(r'notificationId', object);
  }

  Id putByNotificationIdSync(NotificationLocal object,
      {bool saveLinks = true}) {
    return putByIndexSync(r'notificationId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByNotificationId(List<NotificationLocal> objects) {
    return putAllByIndex(r'notificationId', objects);
  }

  List<Id> putAllByNotificationIdSync(List<NotificationLocal> objects,
      {bool saveLinks = true}) {
...
extension NotificationLocalQueryWhereSort
  ...
  QueryBuilder<NotificationLocal, NotificationLocal, QAfterWhere>
      anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension NotificationLocalQueryWhereDistinct
  ...
  QueryBuilder<NotificationLocal, NotificationLocal, QDistinct> distinctByBody(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension NotificationLocalQueryProperty
  ...
  QueryBuilder<NotificationLocal, String?, QQueryOperations> bodyProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationLocal, bool, QQueryOperations> isDeletedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationLocal, String?, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
