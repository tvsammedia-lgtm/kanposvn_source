...
/// Mô hình dữ liệu mô phỏng báo cáo dạng Crystal Reports (.rpt) của
/// KANCAFE (KANCAFE_ONE_V1, TDERP_RES.Reports.*): rp1111 / rp1111_Detail
/// (quỹ tiền mặt), bảng kê bàn theo tầng, danh mục món ăn, giá món ăn.
///
...
class ReportRow {
  ...
  /// Dòng nhãn nhóm/section (VD: "Số dư đầu kỳ", "Khu vực: Tầng 1").
...
class CrystalReportModel {
  /// Dòng "Mẫu số ... / Thông tư..." (căn phải, nhỏ).
  ...
  /// Các dòng phụ (Tháng, Từ ngày - đến ngày...).
